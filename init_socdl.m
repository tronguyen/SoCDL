...
if dtype==1,
	...
	'v_isDeep', 0, ...
        'earlystop', 1e-7,...
        'alpha', 0.1, ...
        'mv_run', alg==13 | alg==1 | alg==2 | alg==-1, ...
        'mc_run', alg==12, ...
        'numwalks', rid, ...
        'coldstart', 1, ...
        ...
        'lq', lbd_q(dspec), ...
        'ls', 0.01, ...
        'decay', 3e-3, ...1e-3 for old
        'momentum', 1e-1, ...
        'mid_momentum', 0.5,...
        'max_momentum', 0.8,...
        'nV', 17632, ...
        'nU', 1892, ...
        'nT', 9749,... % tagged: 109750
        'nF', 200);
...
if params.coldstart,
    ...
    fprintf(1, 'Init data [Dtype: %s - Non-Coldstart]\n', params.data);
end
